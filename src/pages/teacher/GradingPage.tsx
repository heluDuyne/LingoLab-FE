                ...
                <CardContent className="pt-6 space-y-6">
                    ...
                    <div className="bg-purple-50 rounded-xl p-5 border border-purple-100 flex items-center justify-between">
                        <div>
                            ...
                            <div className="text-4xl font-black text-purple-700 leading-none">7.5</div>
                        </div>
                        <div className="text-right space-y-1">
                            <div className="text-xs text-slate-600 flex justify-between gap-4">
                                <span>Task Response:</span> <span className="font-bold text-slate-900">8.0</span>
                            </div>
                            <div className="text-xs text-slate-600 flex justify-between gap-4">
                                <span>Cohesion:</span> <span className="font-bold text-slate-900">7.0</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-2">
                            <li className="text-sm text-slate-600 flex items-start gap-2">
                                ...
                                <span>Strong vocabulary range including terms like "cornerstone" and "robust frameworks".</span>
                            </li>
                            <li className="text-sm text-slate-600 flex items-start gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-green-400 mt-1.5 shrink-0" />
                                <span>Clear stance maintained throughout the entire essay.</span>
                            </li>
                        </ul>
                    </div>
                        ...
                        <h4 className="flex items-center gap-2 font-bold text-slate-900 text-sm">
                         ...
                         <ul className="space-y-2">
                            <li className="text-sm text-slate-600 flex items-start gap-2">
                                ...
                                <span>Minor grammatical slip in second paragraph ("reachable through state intervention").</span>
                            </li>
                            <li className="text-sm text-slate-600 flex items-start gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-1.5 shrink-0" />
                                <span>Could benefit from more complex transition markers.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-slate-50 rounded-lg p-4 border border-slate-100">
                        <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">AI Suggestion</div>
                        <p className="text-sm text-slate-600 italic leading-relaxed">
                            "Consider using 'attainable' instead of 'reachable' for a more academic tone in the context of government policy."
                        </p>
                    </div>
                </CardContent>
            </Card>
